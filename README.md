...
2. open android studio and files -> import project -> /path/to/WearBtPair/
3. click on build project or run it on the actuall device(it sideloads and installes it)
4. sideload it into watch
